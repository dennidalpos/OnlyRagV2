...
| [**`piano_configurazione_prompts.md`**](./piano_configurazione_prompts.md) | Piano operativo dei microtask per l'integrazione del modale gerarchico di configurazione dei prompt e delle regole SLM. |
