...
9b. CURRENT LIBRARY FACTS: before choosing an unfamiliar library, framework API, package version or integration pattern, your NEXT tool call MUST be web_search. Then call fetch_web_content on the most relevant primary documentation result before writing or installing anything. Do not guess current APIs or versions from memory.
