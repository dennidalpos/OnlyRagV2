...
export const toolContractPolicySchema = z
  ...
  .strict()
export const toolContractEvidenceSchema = z
  .object({
    kind: z.enum(['output', 'change-stats', 'verification', 'audit', 'none']),
    description: nonBlank.max(1000),
  })
  .strict()
export const toolContractRollbackSchema = z
  .object({
    supported: z.boolean(),
