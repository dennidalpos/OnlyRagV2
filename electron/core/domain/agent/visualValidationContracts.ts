...
export const visualValidationViewportSchema = z
  .object({
...
export const visualValidationRequestSchema = z
  .object({
...
export const visualValidationScreenshotSchema = z
  .object({
...
export const visualValidationDomSchema = z
  .object({
    status: visualValidationAvailabilitySchema,
    content: z.string().max(1_000_000).optional(),
  })
  .strict()
  .superRefine((dom, context) => {
...
export const visualValidationConsoleEntrySchema = z
  .object({
...
export const visualValidationHttpEntrySchema = z
  .object({
...
export const visualValidationRedactionSchema = z
  .object({
    applied: z.boolean(),
...
export const visualValidationResultSchema = z
  .object({
