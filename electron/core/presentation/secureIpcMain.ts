...
const payloadSchemas: Record<string, z.ZodType> = {
  ...
  'task:clean-residuals': emptyArgs,
  ...
  'diagnostics:get-http-metrics': emptyArgs,
  ...
  'ingest:translate-inplace': z.tuple([sidecarTranslate.docId, sidecarTranslate.sourceLang, sidecarTranslate.targetLang, sidecarTranslate.model, sidecarTranslate.backupOriginal, sidecarTranslate.targetDir, sidecarTranslate.numCtx, sidecarTranslate.think]),
  ...
  'ingest:search': z.tuple([sidecarSearch.query, sidecarSearch.topK, sidecarSearch.embeddingModel, sidecarSearch.docIds]),
