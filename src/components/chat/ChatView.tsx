                  ...
                  <div key={msg.id} className={`flex gap-3 max-w-3xl ${isUser ? 'ml-auto flex-row-reverse' : ''}`}>
                    <div
                      className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 border ${
                        isUser ? 'bg-cyan-600 text-slate-950 border-cyan-500' : 'bg-slate-900 text-cyan-400 border-slate-800'
                      }`}
                    >
                    ...
                    <div className={`space-y-2 group min-w-0 max-w-[85%] ${isUser ? 'items-end' : ''}`}>
                      <div
                        className={`p-4 rounded-2xl text-xs leading-relaxed whitespace-pre-wrap break-words overflow-hidden ${
                          isUser
                                ...
                                return (
                                  <button
                                    ...
                                    className={`w-full text-left p-1.5 rounded-lg text-xs flex items-center justify-between transition-colors ${
                                      isSelected ? 'bg-cyan-950 text-cyan-200 border border-cyan-800/60' : 'hover:bg-slate-800 text-slate-400'
                                    }`}
                                  >
