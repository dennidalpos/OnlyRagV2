...
export const CodingTerminal: React.FC<CodingTerminalProps> = ({
  ...
  return (
    <div className="h-full flex flex-col p-4 font-mono text-xs bg-slate-950 relative select-text">
      {/* Terminal Top Control Bar */}
      <div className="flex items-center justify-between pb-2.5 mb-2 border-b border-slate-800 shrink-0 text-slate-400">
