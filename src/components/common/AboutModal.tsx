...
import { X, Award, Code2, ExternalLink, Copy, Check, Heart, ShieldCheck, Package } from 'lucide-react'
      ...
      <div className="relative p-6 border-b border-slate-800/80 bg-gradient-to-r from-slate-900 via-slate-900 to-cyan-950/40 flex items-start justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 font-medium max-w-xl">{t('about.subtitle')}</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 select-text">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800/90 flex flex-col justify-between space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">{t('about.authorTitle')}</div>
                <div className="text-sm font-bold text-slate-100">{APP_AUTHOR}</div>
              </div>
            </div>
            <div className="text-xs text-slate-400">{t('about.authorRole')}</div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800/90 flex flex-col justify-between space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">{t('about.repositoryTitle')}</div>
                <div className="text-xs font-mono font-semibold text-slate-200 truncate max-w-[160px]">{APP_REPOSITORY_SLUG}</div>
              </div>
            </div>
          ...
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800/90 flex flex-col justify-between space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[11px] text-slate-400 font-semibold uppercase tracking-wider">{t('about.licenseTitle')}</div>
                <div className="text-sm font-bold text-emerald-400 font-mono">{t('about.licenseType')}</div>
              </div>
            </div>
        ...
        <div className="space-y-3">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-800 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">{t('about.creditsSubtitle')}</p>
            </div>
          </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-xs text-slate-100 group-hover:text-cyan-300 transition-colors">{item.name}</span>
                      <span className="text-[10px] font-mono text-cyan-400/80 bg-cyan-950/40 px-1.5 py-0.5 rounded border border-cyan-800/40">
                        {item.version}
                      </span>
                    </div>
                    <span className="text-[9px] font-medium px-1.5 py-0.5 rounded bg-slate-900 border border-slate-800 text-slate-400">{item.license}</span>
                  </div>
        ...
        <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800/90 space-y-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h4 className="text-xs font-bold text-slate-100">{t('about.acknowledgmentsTitle')}</h4>
              <p className="text-[11px] text-slate-400">{t('about.acknowledgmentsSubtitle')}</p>
            </div>
          </div>
        ...
        <div className="p-4 rounded-xl bg-gradient-to-r from-slate-950 to-cyan-950/30 border border-slate-800/90 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-slate-100">{t('about.contactsTitle')}</h4>
              <p className="text-[11px] text-slate-400">{t('about.contactsSubtitle')}</p>
            </div>
          </div>
