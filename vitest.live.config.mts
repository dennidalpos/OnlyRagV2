 ...
 * live run sitting inside `electron/**` gets collected by the normal suite, runs alongside it
 * for minutes, and tears down temp directories other tests are still using. That produced 29
 * phantom failures once — all of them attributed, at first, to the change under test.
 */
